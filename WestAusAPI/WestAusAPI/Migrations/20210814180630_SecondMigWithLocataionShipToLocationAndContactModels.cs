...
{
    public partial class SecondMigWithLocataionShipToLocationAndContactModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipToLocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipToLocations_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShipToLocations_CustomerId",
                table: "ShipToLocations",
                column: "CustomerId");
        }
